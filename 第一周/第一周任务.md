...
> **注意：** 
> - 这里我们使用了用户级环境变量配置，如需系统级配置，请将 "User" 改为 "Machine"
...
# 验证环境变量
Write-Host "ANDROID_HOME 已设置为: $([Environment]::GetEnvironmentVariable('ANDROID_HOME', 'User'))" -ForegroundColor Green
